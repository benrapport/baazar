# The Exchangification Thesis

**The belief that AI will drive a transition from marketplaces to exchanges across many of the world's most important categories.**

## What's here

- **[THESIS.md](THESIS.md)** — The core argument: what exchangification is, why it's happening now, and what it means
- **[HISTORY.md](HISTORY.md)** — Historical precedents: canonical bazaar → marketplace → exchange transitions
- **[CATEGORY_MAP.md](CATEGORY_MAP.md)** — Category-by-category analysis of exchange potential
- **[READING_LIST.md](READING_LIST.md)** — Annotated bibliography of relevant sources
- **[OPEN_QUESTIONS.md](OPEN_QUESTIONS.md)** — Unresolved questions and areas for further research
